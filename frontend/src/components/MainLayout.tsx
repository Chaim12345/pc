  ...
  return (
    <div className="flex h-screen w-full bg-monday-background dark:bg-monday-dark overflow-hidden">
        ...
        <nav className="flex-1 px-3 py-4 space-y-2 overflow-y-auto custom-scrollbar">
          ...
          {!sidebarCollapsed && (
            <>
                  ...
                  <div className="space-y-1">
                    {favoriteBoardsList.map((board) => (
                      <div key={board.id} className="group flex items-center">
                        ...
                        <button onClick={() => toggleFavoriteBoard(board.id)} className="p-1 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <div className="pt-4 pb-2">
                <div className="flex items-center justify-between px-3 mb-2">
                  <button onClick={toggleBoardsExpanded} className="flex items-center space-x-1">
        ...
        <header className="h-16 bg-white dark:bg-monday-darkLight border-b border-monday-border dark:border-gray-700 flex items-center justify-between px-6 flex-shrink-0 shadow-sm z-10">
          ...
          <div className="flex items-center space-x-4 flex-shrink-0">
            ...
            <div className="relative">
              ...
              {showUserMenu && (
                <div
                  className="absolute right-0 mt-2 w-56 bg-white dark:bg-monday-darkLight rounded-lg shadow-monday-hover border border-monday-border dark:border-gray-700 z-50 py-2 animate-in fade-in slide-in-from-top-2 duration-200"
                  role="menu"
      ...
      {showCreateModal && (
        ...
        >
          <div
            className="bg-white dark:bg-monday-darkLight rounded-xl shadow-2xl max-w-md w-full p-6 animate-in slide-in-from-bottom-4 zoom-in-95 duration-300"
            role="document"
          >
            <div className="flex items-center justify-between mb-6">
              <h3 id="create-board-title" className="text-2xl font-bold text-monday-text dark:text-white flex items-center space-x-2">
                <svg className="w-7 h-7 text-monday-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>
