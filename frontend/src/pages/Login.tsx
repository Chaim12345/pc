      ...
      <div className="flex-1 flex items-center justify-center px-8 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#323338] dark:text-white mb-2">{t('auth.welcomeBack', 'Welcome back')}</h1>
            <p className="text-[#676879] dark:text-[#d1d5db] text-base">{t('auth.loginDescription', 'Log in to your account to continue')}</p>
          </div>
            ...
            {!twoFactorRequired ? (
              ...
              <form onSubmit={handle2FAVerify} className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <h2 className="text-xl font-bold text-[#323338] dark:text-white mb-2">{t('auth.twoFactorAuth', 'Two-Factor Authentication')}</h2>
                  <p className="text-sm text-[#676879] dark:text-[#d1d5db]">{t('auth.enterVerificationCode', 'Enter the verification code from your authenticator app')}</p>
                </div>
              ...
              <>
                <div className="relative my-8">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-white dark:bg-[#18181b] text-[#9699a6] dark:text-[#9ca3af]">{t('auth.orContinueWith', 'Or continue with')}</span>
                  </div>
                </div>
                ...
                <div className="text-center mt-6 pt-6 border-t border-[#e6e9ef] dark:border-[#3f3f46]">
                  <span className="text-sm text-[#676879] dark:text-[#d1d5db]">{t('auth.noAccount', "Don't have an account?")} </span>
